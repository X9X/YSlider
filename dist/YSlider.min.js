...
var YSlider = exports.YSlider = function () {
    ...
    _createClass(YSlider, [{
        ...
        value: function _loadSlide() {
            var nextSlide = this._slider.children[this.currentSlide].nextElementSibling;
            var prevSlide = this._slider.children[this.currentSlide].previousElementSibling;
            [nextSlide, prevSlide].forEach(function (slide) {
